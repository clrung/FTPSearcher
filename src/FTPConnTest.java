...
public class FTPConnTest {
	...
	@Test
	public void testConnect() throws ConnectException, IOException, FTPConn.LoginFailedException {
	...
	public void testConnect2() throws ConnectException, IOException, FTPConn.LoginFailedException, UnknownHostException {
		testConn = new FTPConn("asdaersdf", USER_NAME, PASSWORD);
		testConn.connect();
	}

	@Test(expected = ConnectException.class)
	public void testConnect3() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn("134.83.168.211", USER_NAME, PASSWORD);
		this.testConn.connect();
	}

	@Test(expected = ConnectException.class)
	public void testConnect4() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn("", USER_NAME, PASSWORD);
		this.testConn.connect();
	}

	@Test(expected = FTPConn.LoginFailedException.class)
	public void testConnect5() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn(SERVER_NAME, "134.82.168.211", PASSWORD);
		this.testConn.connect();
	}

	@Test(expected = FTPConn.LoginFailedException.class)
	public void testConnect6() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn(SERVER_NAME, "", PASSWORD);
		this.testConn.connect();
	}

	@Test(expected = FTPConn.LoginFailedException.class)
	public void testConnect7() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn(SERVER_NAME, USER_NAME, "demo_p");
		this.testConn.connect();
	}

	@Test(expected = FTPConn.LoginFailedException.class)
	public void testConnect8() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn(SERVER_NAME, USER_NAME, "");
		this.testConn.connect();
	}

	@Before
	public void setUp() throws ConnectException, IOException, FTPConn.LoginFailedException {
		this.testConn = new FTPConn(SERVER_NAME, USER_NAME, PASSWORD);
		this.testConn.connect();
	}
	...
	public void testGetAllContents() throws IOException {
		...
		assertTrue(contents.get(contents.size() - 1).equalsIgnoreCase("File: windowstestprogram1.exe"));
	}
	...
	public void testGetFiles() throws IOException {
		...
		assertTrue(files.get(files.size() - 1).getName().equals("windowstestprogram1.exe"));
